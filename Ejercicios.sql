...
select r.rental_date as fecha_alquiler , r.rental_id as id_alquiler , p.amount as precio
from rental r 
...
select r.rental_date as fecha_alquiler , r.inventory_id as total_alquileres
from rental r 
...
select f.title as pelicula , count(i.inventory_id) cantidad_disponible
from film f 
...
order by peliculas_participadas ;
...
select count(f.film_id) as total_peliculas , f.release_year as año_estreno
from film f 
